...
a = pd.read_csv(path + r"SimulationResults\\Comparison_k_20\\Comparison_FB100.csv")
...
for Network in Networks:
    ...
    plt.savefig(path + r"SimulationResults\\FOI_Pics\\ComparisonPics\\k_20\\FB100_" + Network + "_Incidence.png")
    plt.close()
