...
a = pd.read_csv(path + r"SimulationResults\\Comparison_k_40\\Comparison_BA.csv")
...
for m in ms:
    ...
    plt.savefig(path + r"SimulationResults\\FOI_Pics\\ComparisonPics\\k_40\\BA_M_" + str(m) +  "_Incidence.png")
    plt.close()
