...
a = pd.read_csv(path + r"SimulationResults\\Comparison_Blocks\\Comparison_BlockModel.csv")
a0 = pd.read_csv(path + r"SimulationResults\\Comparison_Blocks\\Comparison_BlockModel_Partition_0.csv")
a1 = pd.read_csv(path + r"SimulationResults\\Comparison_Blocks\\Comparison_BlockModel_Partition_1.csv")
...
for part in Parts:
    ...
    plt.savefig(path + r"SimulationResults\\FOI_Pics\\ComparisonPics\\BlockModels\\BlockModel_Incidence_" + part + ".png")
    plt.close()
    del fig
    del ax
