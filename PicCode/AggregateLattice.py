...
First = True
path = Path.GetPath()
ComplexFile = "SimulationResults/ComplexComparison_Lattice.csv"
SimpleFile = "SimulationResults/SimpleComparison_Lattice.csv"
CSV_Save_Name = "SimulationResults/Comparison_Lattice.csv"
