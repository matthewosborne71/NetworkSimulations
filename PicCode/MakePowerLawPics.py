...
a = pd.read_csv(path + r"SimulationResults\\Comparison_k_2\\Comparison_PowerLaw.csv")
...
for e in Exps:
    ...
    plt.savefig(path + r"SimulationResults\\FOI_Pics\\ComparisonPics\\k_2\\PowerLawIncidence_exp_" + str(np.round(e,4)) + ".png")
    plt.close()
    del fig
    del ax
