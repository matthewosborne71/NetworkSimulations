...
a = pd.read_csv(path + r"SimulationResults\\Comparison_k_2\\Comparison_Lattice.csv")
...
for p in RewiringProbs:
    ...
    plt.savefig(path + r"SimulationResults\\FOI_Pics\\ComparisonPics\\k_40\\Lattice_Incidence.png")
    plt.close()
    del fig
    del ax
