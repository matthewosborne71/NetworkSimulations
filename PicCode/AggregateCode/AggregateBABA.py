...
path = Path.GetPath()
ComplexFile = "SimulationResults/ComplexContagionSimulations_BA_BA.csv"
SimpleFile = "SimulationResults/SimpleContagionSimulations_BA_BA.csv"
CSV_Save_Names = ["SimulationResults/Comparison_BA_BA.csv",
                    "SimulationResults/Comparison_BA_BA_Partition_0.csv",
                    "SimulationResults/Comparison_BA_BA_Partition_1.csv"]
