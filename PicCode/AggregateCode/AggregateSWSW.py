...
path = Path.GetPath()
ComplexFile = "SimulationResults/ComplexContagionSimulations_SW_SW.csv"
SimpleFile = "SimulationResults/SimpleContagionSimulations_SW_SW.csv"
CSV_Save_Names = ["SimulationResults/Comparison_SW_SW.csv",
                    "SimulationResults/Comparison_SW_SW_Partition_0.csv",
                    "SimulationResults/Comparison_SW_SW_Partition_1.csv"]
