...
DataName = "SimulationResults/Comparison_Blocks/Comparison_PL_PL.csv"
DataName0 = "SimulationResults/Comparison_Blocks/Comparison_PL_PL_Partition_0.csv"
DataName1 = "SimulationResults/Comparison_Blocks/Comparison_PL_PL_Partition_1.csv"

SaveStarter = "SimulationResults/FOI_Pics/ComparisonPics/BlockModels/PL_PL_Incidence_"
...
for part in Parts:
    ...
    fig.suptitle("PL PL Block Model, Partition: " + str(part) + ", Time Round: " + str(time))
