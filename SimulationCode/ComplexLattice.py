...
logging.basicConfig(filename = path + "Logs/ComplexSimLattice.log",
                    format = '%(asctime)s - %(message)s',
                    level = logging.INFO)

f = open(path + "SimulationResults/ComplexComparison_Lattice.csv","w+")
...
logging.info("About to run the simulations for the Complex Contagion 1-D Lattice Network.\r\n")
