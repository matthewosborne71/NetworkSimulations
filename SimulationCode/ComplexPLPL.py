...
Thresholds = [0.01,0.02,0.03,0.05,0.06,0.07,0.08,0.09,0.1,0.11,0.12]
...
logging.basicConfig(filename = path + "Logs/ComplexPLPL.log",
                    format = '%(asctime)s - %(message)s',
                    level = logging.INFO)

f = open(path + "SimulationResults/ComplexContagionSimulations_PL_PL.csv","w+")
